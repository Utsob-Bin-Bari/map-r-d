...
export const ClientCard = ({ id, name, service, date, distance, duration, startTime, endTime, status, price, image, type }: ClientCardProps) => {
        ...
        <TouchableOpacity style={styles.container} onPress={() => { console.log(id); }}>
            ...
            <View style={styles.contentContainer}>
                <View style={styles.timeContainer}>
                    <View style={styles.dateContainer}>
                        ...
                        <Text textThemeName="captionRegular" style={{color:Colors.primaryInputText}} numberOfLines={1}>{relativeDate}</Text>
                    </View>
                    <View style={styles.timeSlotContainer}>
                        <HugeiconsIcon icon={Clock01Icon} size={16} strokeWidth={2} color={Colors.primaryInputText}/>
                        <Text textThemeName="captionRegular" style={{color:Colors.primaryInputText}} numberOfLines={1}>{startTime} - {endTime}</Text>
                    </View>
                </View>
            ...
            <View style={styles.actionContainer}>
                {type === 'withoutNavigation' && (
                    ...
                    <Button text="View Details" onPress={() => { console.log(id); }} buttonBackgroundColor='transparent' height={40} width={165} borderRadius={10}/>
                    </>
                )}
                {type === 'withNavigation' && (
                    <>
