...
export const ProfileDetailsScreen = ({ minimumBookingPrice=85, maximumBookingPrice=90, timeSlot=60 }: { minimumBookingPrice: number, maximumBookingPrice: number, timeSlot: number}) => {
    ...
    return (
        <View style={[GlobalContainerStyles.wrapperFlexWithPaddingToHeader,{backgroundColor:'#F5F1EC'}]}>
            ...
            <View style={{marginVertical: 10, width:'100%', alignSelf:'center'}}>
                ...
                {activeTab === 3 && <Review overallRating={4.8} totalReviews={150} reviews={reviews} />}
            </View>
